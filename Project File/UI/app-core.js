...
const readerSettingsContainer = document.getElementById(
...
const settingNightIntensity = document.getElementById(
  "setting-night-intensity",
);
...
const btnReaderSearchToggle = document.getElementById(
  "btn-reader-search-toggle",
);
...
const btnResetNightIntensity = document.getElementById(
  "btn-reset-night-intensity",
);
const btnPreviewNightIntensity = document.getElementById(
  "btn-preview-night-intensity",
);
const scrollProgressIndicator = document.getElementById(
...
async function loadData() {
  ...
  if (data) {
    ...
    userSettings.nightModeIntensity =
      data.nightModeIntensity !== undefined ? data.nightModeIntensity : 50;
    userSettings.pdfQualityMode =
      data.pdfQualityMode === "original" ? "original" : "light";
...
function t(key) {
  return (
    (translations[userSettings.language] &&
      translations[userSettings.language][key]) ||
    key
  );
}
